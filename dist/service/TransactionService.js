...
let TransactionService = class TransactionService extends BaseService_1.BaseService {
    ...
    async sendContractTransaction(contract, method, args = [], config = {}) {
        const chainInfo = this.connectInfo.chainInfo();
        ...
        config.maxPriorityFeePerGas = config.maxPriorityFeePerGas || chainInfo.txBaseConfig.maxPriorityFeePerGas;
        config.maxFeePerGas = config.maxFeePerGas || chainInfo.txBaseConfig.maxFeePerGas;
        config.gasPrice = config.maxFeePerGas || chainInfo.txBaseConfig.gasPrice;
