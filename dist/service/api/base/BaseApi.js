...
class BaseApi {
    ...
    async prepGraph(params) {
        return this.graphBase(`${(0, Constant_1.getCurrentAddressInfo)().graphUrl}/agni/prep`, params.gql, params.params);
    }
    connectInfo(chainInfo) {
        return (0, Constant_1.getCurrentAddressInfo)().readonlyConnectInfo(chainInfo);
    }
    getCurrentConnectInfo(chainType) {
        const addressInfo = exports.BASE_API.address();
