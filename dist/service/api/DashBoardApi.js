...
let DashBoardApi = class DashBoardApi {
    async poolPosition(chainType) {
        ...
        const positionDatas = positionDataDtos.reduce((acc, cur) => {
            ...
            const pnlValue = tool_1.MarketTradeMath.pnl(openPosition.isLong, openPosition.targetAmount, openPosition.openPrice, new bignumber_js_1.default(tickPrice.close).multipliedBy(10 ** vo_1.CONST.PRICE_DECIMALS).toFixed(0, bignumber_js_1.default.ROUND_DOWN), openPosition.margin);
