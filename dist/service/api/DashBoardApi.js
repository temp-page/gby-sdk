...
let DashBoardApi = class DashBoardApi {
    ...
    async index(chainType) {
        ...
        return {
            ...
            totalTradingVolume: (0, get_1.default)(prepDashboardDto, 'positionInfos[0].count', '0'),
            totalStakers: (0, get_1.default)(prepDashboardDto, 'alpholderInfos[0].totalPosition', '0')
        };
    }
};
