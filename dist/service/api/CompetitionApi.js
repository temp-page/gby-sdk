...
let CompetitionApi = class CompetitionApi {
    ...
    async claimInfo(address) {
        ...
        const claimed = !claimInfo.claimInfo ? false : await ci.create(contract_1.TradeRewardsContract, claimInfo.claimInfo.contract).getClaimed(claimInfo.claimInfo.round, claimInfo.claimInfo.address);
        return {
            address: address,
