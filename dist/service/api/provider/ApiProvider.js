...
const PythApi_1 = require("../PythApi");
const ReferralApi_1 = require("../ReferralApi");
const CompetitionApi_1 = require("../CompetitionApi");
/**
 * 请求基类 详细信息查看
 */
class ApiProvider {
    ...
    pythApi() {
        return (0, tool_1.mixProxy)(PythApi_1.PythApi);
    }
    referralApi() {
        return (0, tool_1.mixProxy)(ReferralApi_1.ReferralApi);
    }
    competitionApi() {
        return (0, tool_1.mixProxy)(CompetitionApi_1.CompetitionApi);
    }
}
