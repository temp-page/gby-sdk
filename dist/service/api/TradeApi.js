...
let TradeApi = class TradeApi {
    ...
    positionRecordAbiResultToPositionData(positionRecordAbiResult, pairs, tokens) {
        ...
        positionData.netProfit = new bignumber_js_1.default(positionData.netProfit).minus(positionData.openFee).minus(positionData.execFee).minus(positionData.closeFee).plus(positionData.fundingFee).toFixed();
