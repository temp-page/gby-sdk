...
let TradeApi = class TradeApi {
    ...
    positionRecordAbiResultToPositionData(positionRecordAbiResult, pairs) {
        ...
        const positionData = {
            ...
            qty: new bignumber_js_1.default(positionRecordAbiResult.targetAmount).multipliedBy(positionRecordAbiResult.closePrice).div(10 ** vo_1.CONST.QTY_DECIMALS).div(10 ** vo_1.CONST.PRICE_DECIMALS).toFixed(),
            ...
            fundingFee: new bignumber_js_1.default("0").toFixed(8, bignumber_js_1.default.ROUND_DOWN),
            ...
            closePrice: new bignumber_js_1.default(positionRecordAbiResult.closePrice).div(10 ** vo_1.CONST.PRICE_DECIMALS).toFixed(8, bignumber_js_1.default.ROUND_DOWN),
