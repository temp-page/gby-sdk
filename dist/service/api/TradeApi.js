...
exports.TradeApi = exports.BOOST = exports.TargetType = void 0;
...
let TradeApi = class TradeApi {
    ...
    async tradeInfo(chainType, targetName, referralCode) {
        ...
        const tradeInfo = {
            ...
            TPSLInfo: async (positionHash) => {
                ...
                return this.TPSLInfo(chainType, positionData);
            }
        };
    ...
    updateFundingFee(positionData, blockTime, targetConfigMap) {
        ...
        const fundingFeeAmount = new bignumber_js_1.default(fundingFee).div(10 ** vo_1.CONST.QTY_DECIMALS).div(10 ** vo_1.CONST.PRICE_DECIMALS).multipliedBy(-1).toFixed();
    ...
    preOpenPosition(preOpenPositionParams, tick, targetConfig) {
        ...
        if (!(0, tool_1.isNumber)(tp.price) || new bignumber_js_1.default(tp.rate).comparedTo("0") <= 0 || new bignumber_js_1.default(tp.rate).comparedTo("200") > 0) {
            tp.error = true;
        }
    ...
    async addMarginInfo(chainType, positionData, supportedTokens) {
        ...
        const addMarginInfo = {
            ...
            preAddMargin(amount) {
                ...
                const liquidationPrice = new bignumber_js_1.default(liquidPrice).div(10 ** vo_1.CONST.PRICE_DECIMALS).toFixed(8, bignumber_js_1.default.ROUND_DOWN);
    ...
    async TPSLInfo(chainType, positionData) {
        const addressInfo = BaseApi_1.BASE_API.address();
        const positionHash = positionData.sourceData.positionHash;
        const calculatePriceThresholdRatio = tool_1.MarketTradeMath.calculatePriceThresholdRatio(positionData.sourceData.initMargin, positionData.sourceData.targetAmount, positionData.sourceData.targetOpenPrice, positionData.sourceData.takeProfitPrice, positionData.sourceData.stopLossPrice, positionData.sourceData.liquidPrice);
        const sourceTP = {
        ...
        const TPSLInfo = {
            ...
            preUpdate(tpParams, slParams) {
                ...
                if (tpParams.inputType === "price") {
                    ...
                    const rate = tool_1.MarketTradeMath.takeProfit(positionData.isLong, new bignumber_js_1.default(tp.price).multipliedBy(10 ** vo_1.CONST.PRICE_DECIMALS).toFixed(0, bignumber_js_1.default.ROUND_DOWN), positionData.sourceData.initMargin, positionData.sourceData.targetAmount, positionData.sourceData.targetOpenPrice);
                    tp.rate = new bignumber_js_1.default(rate).minus(1e6).div(10 ** vo_1.CONST.RATIO_DECIMALS).toFixed(vo_1.CONST.RATIO_DECIMALS, bignumber_js_1.default.ROUND_DOWN);
                }
                ...
                if (slParams.inputType === "price") {
                    ...
                    const rate = tool_1.MarketTradeMath.stopLossRate(positionData.isLong, new bignumber_js_1.default(sl.price).multipliedBy(10 ** vo_1.CONST.PRICE_DECIMALS).toFixed(0, bignumber_js_1.default.ROUND_DOWN), positionData.sourceData.initMargin, positionData.sourceData.targetAmount, positionData.sourceData.targetOpenPrice);
                    sl.rate = new bignumber_js_1.default(1e6).minus(rate).div(10 ** vo_1.CONST.RATIO_DECIMALS).toFixed(vo_1.CONST.RATIO_DECIMALS, bignumber_js_1.default.ROUND_DOWN);
                }
