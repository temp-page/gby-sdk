...
let TradeApi = class TradeApi {
    ...
    preOpenPosition(preOpenPositionParams, tick, targetConfig) {
        ...
        const openPosition = {
            ...
            liqPrice: liqPrice,
            openFee: new bignumber_js_1.default(openFee).div(10 ** vo_1.CONST.QTY_DECIMALS).div(10 ** vo_1.CONST.PRICE_DECIMALS).toFixed(8, bignumber_js_1.default.ROUND_DOWN),
            closeFee: new bignumber_js_1.default(closeFee).div(10 ** vo_1.CONST.QTY_DECIMALS).div(10 ** vo_1.CONST.PRICE_DECIMALS).toFixed(8, bignumber_js_1.default.ROUND_DOWN),
            execFee: new bignumber_js_1.default(targetConfig.execFeeValue).div(10 ** vo_1.CONST.QTY_DECIMALS).div(10 ** vo_1.CONST.PRICE_DECIMALS).toFixed(8, bignumber_js_1.default.ROUND_DOWN)
        };
        return openPosition;
    }
