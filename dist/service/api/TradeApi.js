...
let TradeApi = TradeApi_1 = class TradeApi {
    ...
    preOpenPosition(preOpenPositionParams, tick, targetConfig) {
        ...
        const openPosition = {
            ...
            openFeeUSD: new bignumber_js_1.default(openFeeUSD).toFixed(2, bignumber_js_1.default.ROUND_DOWN),
            execFeeUSD: new bignumber_js_1.default(execFeeUSD).toFixed(2, bignumber_js_1.default.ROUND_DOWN),
            tp,
            sl,
