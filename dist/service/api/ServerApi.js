...
let ServerApi = class ServerApi {
    ...
    async competitionListAll() {
        return BaseApi_1.BASE_API.request(BaseApi_1.BASE_API.address().baseApiUrl + `/prep_api/api/v1/competition/listAll`, 'get', {});
    }
    async competitionUpdateReward(data) {
        return BaseApi_1.BASE_API.request(BaseApi_1.BASE_API.address().baseApiUrl + `/prep_api/api/v1/competition/updateReward`, 'post', data);
    }
};
