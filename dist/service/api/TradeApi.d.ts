...
export declare class TradeApi {
    ...
    private startEvent;
    tradeInfo(chainType: ChainType, targetName: string, referral?: string): Promise<TradeInfo>;
    ...
    openPosition(connectInfo: ConnectInfo, preOpenPositionParams: OpenPositionParams, targetTick: TargetTick, referral?: string): Promise<OpenPositionEvent>;
