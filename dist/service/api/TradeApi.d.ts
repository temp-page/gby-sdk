import { AddMarginInfo, ChainType, ClosePositionEvent, OpenPosition, OpenPositionConfig, OpenPositionEvent, OpenPositionParams, PositionData, Target, TargetTick, TokenPriceBalance, TPSLInfo, TPSLParams, TPSLResult, TradeInfo, VaultToken } from "../vo";
...
export declare class TradeApi {
    ...
    addMarginInfo(chainType: ChainType, positionData: PositionData): Promise<AddMarginInfo>;
    TPSLInfo(tradeInfo: TradeInfo, positionData: PositionData): Promise<TPSLInfo>;
    static checkSlError(sl: TPSLResult, isLong: boolean, boost: boolean, closePrice: string, slParams: TPSLParams, params: {
        margin: string;
        targetAmount: string;
        targetPrice: string;
    }): boolean;
    static checkTpError(tp: TPSLResult, isLong: boolean, closePrice: string, tpParams: TPSLParams, params: {
        margin: string;
        targetAmount: string;
        targetPrice: string;
    }): boolean;
