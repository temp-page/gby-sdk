...
class MarketTradeMath {
    ...
    static initTargetFundingFeeRate(targetTick, getTargetConfig) {
        ...
        const fundingRateLong = new bignumber_js_1.default(targetTick.longOI).eq("0") ? "0" : new bignumber_js_1.default(fundingRate).multipliedBy(new bignumber_js_1.default(targetTick.shortOI).minus(new bignumber_js_1.default(targetTick.longOI))).div(new bignumber_js_1.default(targetTick.longOI)).multipliedBy(100).toFixed();
        //  fundingRateShort =fundingRate  *  （ShortOI  - LongOI） / ShortOI
        const fundingRateShort = new bignumber_js_1.default(targetTick.shortOI).eq("0") ? "0" : new bignumber_js_1.default(fundingRate).multipliedBy(new bignumber_js_1.default(targetTick.longOI).minus(new bignumber_js_1.default(targetTick.shortOI))).div(new bignumber_js_1.default(targetTick.shortOI)).multipliedBy(100).toFixed();
