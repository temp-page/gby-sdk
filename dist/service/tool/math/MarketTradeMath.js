...
class MarketTradeMath {
    ...
    static initTargetFundingFeeRate(targetTick, getTargetConfig) {
        //fundingFeePerBlockTimeP * 1e18 * 1 * 60 * 60  / 1额0 / 1e18
        const fundingRate = new bignumber_js_1.default(getTargetConfig.fundingFeePerBlockP).multipliedBy(1e18).multipliedBy(1).multipliedBy(60).multipliedBy(60).div(1e10).div(1e18).toFixed();
