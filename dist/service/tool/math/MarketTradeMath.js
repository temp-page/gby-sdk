    ...
    static takeProfitPrice(isLong, takeProfit, margin, targetAmount, targetPrice) {
        if (isLong) {
            ...
            return new bignumber_js_1.default(targetPrice)
                .minus(new bignumber_js_1.default(takeProfit).minus(new bignumber_js_1.default(100).multipliedBy(new bignumber_js_1.default(10).pow(vo_1.CONST.RATIO_DECIMALS))).multipliedBy(margin).dividedBy(new bignumber_js_1.default(100).multipliedBy(new bignumber_js_1.default(10).pow(vo_1.CONST.RATIO_DECIMALS))).dividedBy(targetAmount))
                .dp(0, bignumber_js_1.default.ROUND_DOWN)
                .toFixed(0, bignumber_js_1.default.ROUND_DOWN);
        }
    }
