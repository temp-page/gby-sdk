...
exports.aggregateData = exports.generatePriceLine = void 0;
...
function aggregateData(priceLines) {
    if (priceLines.length > 0) {
        const kline = {
            time: priceLines[0].time,
            priceUSD: new bignumber_js_1.default(priceLines[0].priceUSD).toFixed()
        };
        return kline;
    }
    else {
    ...
    for (const exchangeKLine of klines) {
        while (list.length < size && id >= exchangeKLine.time) {
            if (id === exchangeKLine.time) {
                ...
                const kline = {
                    time: id,
                    priceUSD: new bignumber_js_1.default(exchangeKLine.priceUSD).toFixed(),
                };
                if (contain) {
                    list.push(kline);
                }
...
__exportStar(require("./TradeEventBus"), exports);
