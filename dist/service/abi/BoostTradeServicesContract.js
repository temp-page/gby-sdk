...
let BoostTradeServicesContract = class BoostTradeServicesContract extends BaseAbi_1.BaseAbi {
    ...
    async openBoostTrade(isLong, targetID, tokenID, tokenAmount, leverage, takeProfit, priceUpdateData, referral) {
        return await this.connectInfo
            .tx()
            .sendContractTransaction(this.contract, 'openBoostTrade', [isLong, targetID, tokenID, tokenAmount, leverage, takeProfit, priceUpdateData, referral], {});
    }
