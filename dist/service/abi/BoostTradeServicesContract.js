    ...
    async openBoostTrade(isLong, targetID, tokenID, tokenAmount, leverage, takeProfit, priceUpdateData, referralCode) {
        if (referralCode) {
            return await this.connectInfo
                .tx()
                .sendContractTransaction(this.contract, 'openBoostTrade(bool,bytes32,bytes32,uint256,uint256,uint32,bytes[],bytes32)', [isLong, targetID, tokenID, tokenAmount, leverage, takeProfit, priceUpdateData, referralCode], {});
        }
        else {
            return await this.connectInfo
                .tx()
