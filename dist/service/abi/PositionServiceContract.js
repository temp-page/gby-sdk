...
let PositionServiceContract = class PositionServiceContract extends BaseAbi_1.BaseAbi {
    ...
    multicall_listLivePosition() {
        return this.mulContract['listLivePosition()']();
    }
    multicall_listLivePositionByAccount(account) {
        return this.mulContract['listLivePosition(address)'](account);
    }
    multicall_listLivePositionByPage(account, pageIndex, pageSize) {
        return this.mulContract['listLivePosition(address,uint256,uint256)'](account, pageIndex, pageSize);
    }
    multicall_listHistoryPosition() {
        return this.mulContract['listLivePosition()']();
    }
    multicall_listHistoryPositionByAccount(account) {
        return this.mulContract['listHistoryPosition(address)'](account);
    }
    multicall_listHistoryPositionByPage(account, pageIndex, pageSize) {
