...
let VaultServiceContract = class VaultServiceContract extends BaseAbi_1.BaseAbi {
    ...
    async claimShare(tokenAddress) {
        return await this.connectInfo
            .tx()
            .sendContractTransaction(this.contract, 'claimShare', [tokenAddress], {});
    }
    ...
    multicall_getAccountClaimableAmount(account, tokenAddress) {
        return this.mulContract.getAccountClaimableAmount(account, tokenAddress);
    }
...
], VaultServiceContract.prototype, "claimShare", null);
__decorate([
    (0, tool_1.EnableLogs)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
