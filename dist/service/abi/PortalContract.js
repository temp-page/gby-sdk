...
let PortalContract = class PortalContract extends BaseAbi_1.BaseAbi {
    ...
    multicall_getPrice(assetID) {
        return this.mulContract.getPrice(assetID);
    }
    multicall_GlpPrice() {
        return this.mulContract.GlpPrice();
    }
    multicall_getVaultValue() {
        return this.mulContract.getVaultValue();
    }
};
