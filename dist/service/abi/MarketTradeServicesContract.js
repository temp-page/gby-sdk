...
let MarketTradeServicesContract = class MarketTradeServicesContract extends BaseAbi_1.BaseAbi {
    ...
    async openBoostTrade(isLong, targetID, tokenID, tokenAmount, leverage, takeProfit, nonce) {
        return await this.connectInfo
            .tx()
            .sendContractTransaction(this.contract, 'openBoostTrade', [isLong, targetID, tokenID, tokenAmount, leverage, takeProfit, nonce], {});
    }
    async closeBoostTrade(positionHash, nonce) {
        return await this.connectInfo
            .tx()
            .sendContractTransaction(this.contract, 'closeBoostTrade', [positionHash, nonce], {});
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Boolean, String, String, String, String, String, String]),
