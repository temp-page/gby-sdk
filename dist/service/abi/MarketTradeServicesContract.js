...
let MarketTradeServicesContract = class MarketTradeServicesContract extends BaseAbi_1.BaseAbi {
    ...
    async openBoostTrade(isLong, targetID, tokenID, tokenAmount, leverage, takeProfit, priceUpdateData) {
        return await this.connectInfo
            .tx()
            .sendContractTransaction(this.contract, 'openBoostTrade', [isLong, targetID, tokenID, tokenAmount, leverage, takeProfit, priceUpdateData], {});
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [Boolean, String, String, String, String, String, Array]),
