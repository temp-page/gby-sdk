...
exports.ERC20Contract = exports.ERC20MultiCall = void 0;
const abi_1 = require("../../abi");
const tool_1 = require("../tool");
const BaseAbi_1 = require("./BaseAbi");
class ERC20MultiCall {
...
exports.ERC20MultiCall = ERC20MultiCall;
let ERC20Contract = class ERC20Contract extends BaseAbi_1.BaseAbi {
    constructor(connectInfo, token) {
        super(connectInfo, token, abi_1.IERC20Abi);
        this.multiCall = new ERC20MultiCall(this.mulContract);
    }
    ...
    multicall_balanceOf(account) {
        // eslint-disable-next-line prefer-rest-params
        const args = arguments;
        return this.mulContract.balanceOf(...args);
    }
    multicall_name() {
    ...
    multicall_allowance(userAddress, exchangeAddress) {
