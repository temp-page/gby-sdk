...
export declare class MarketTradeServicesContract extends BaseAbi {
    ...
    openBoostTrade(isLong: boolean, targetID: string, tokenID: string, tokenAmount: string, leverage: string, takeProfit: string, priceUpdateData: string[]): Promise<TransactionEvent>;
