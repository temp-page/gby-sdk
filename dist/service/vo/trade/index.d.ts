...
export interface TradeInfo {
    ...
    preOpenPosition(params: OpenPositionParams): OpenPosition;
     ...
     * 当前持仓
     */
    positions(account: string, updateAccount?: boolean): Promise<PositionData[]>;
    /**
     * 历史持仓
     */
    ...
    addMarginInfo(positionHash: string): Promise<AddMarginInfo>;
    TPSLInfo(positionHash: string): Promise<TPSLInfo>;
    closeTopic(): void;
}
...
export interface AddMarginInfo {
    balance: BalanceAndAllowance;
    addMargin(amount: string, connectInfo: ConnectInfo): Promise<TransactionEvent>;
    preAddMargin(amount: string): {
        margin: string;
...
export interface TPSLInfo {
    sourceTP: TPSLResult;
    sourceSL: TPSLResult;
    preUpdate(tpParams: TPSLParams, slParams: TPSLParams): {
        tp: TPSLResult;
        sl: TPSLResult;
    };
    update(tp: TPSLParams, sl: TPSLParams, connectInfo: ConnectInfo): Promise<TransactionEvent>;
}
