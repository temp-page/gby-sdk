...
export declare class MarketTradeServicesContract extends BaseAbi {
    ...
    closeMarketTrade(postionHash: string, priceUpdateData: string[]): Promise<TransactionEvent>;
    openMarketTrade(isLong: boolean, targetID: string, tokenID: string, tokenAmount: string, leverage: string, takeProfit: string, stopLoss: string, priceUpdateData: string[], referral: string): Promise<TransactionEvent>;
}
