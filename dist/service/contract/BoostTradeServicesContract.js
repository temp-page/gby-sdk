...
// codegen for src/abi/service/BoostTradeServices.json time 2024-08-09T14:30:06.773Z
let BoostTradeServicesContract = class BoostTradeServicesContract extends BaseAbi_1.BaseAbi {
    ...
    // openBoostTrade(bool, bytes32, bytes32, uint256, uint256, uint32, bytes[], bytes32) nonpayable returns()
    openBoostTrade(isLong, targetID, tokenID, tokenAmount, leverage, takeProfit, priceUpdateData, referral) {
        if (referral) {
