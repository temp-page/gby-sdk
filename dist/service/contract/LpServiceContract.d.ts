...
export declare class LpServiceContract extends BaseAbi {
    ...
    handleBurnALP(account: string, assetID: string, amountALP: string, acceptableMinTokenAmount: string, tokenPrice: string, vaultValue: string, tokenValueInVault: string): Promise<TransactionEvent>;
    handleMintALP(account: string, assetID: string, tokenAmount: string, acceptableMinAlpAmount: string, tokenPrice: string, vaultValue: string, tokenValueInVault: string): Promise<TransactionEvent>;
