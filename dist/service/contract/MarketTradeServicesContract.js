...
// codegen for src/abi/service/MarketTradeServices.json time 2024-07-27T13:51:30.456Z
let MarketTradeServicesContract = class MarketTradeServicesContract extends BaseAbi_1.BaseAbi {
    ...
    openMarketTrade(isLong, targetID, tokenID, tokenAmount, leverage, takeProfit, stopLoss, priceUpdateData, referral) {
        if (referral) {
            ...
            return this.connectInfo.tx().sendContractTransaction(this.contract, 'openMarketTrade', [isLong, targetID, tokenID, tokenAmount, leverage, takeProfit, stopLoss, priceUpdateData], {
                value: undefined
            });
        }
    }
