...
// codegen for src/abi/service/PositionService.json time 2024-12-03T02:21:42.483Z
let PositionServiceContract = class PositionServiceContract extends BaseAbi_1.BaseAbi {
    ...
    // addPositionMargin(bytes32, uint256, bytes[]) payable returns()
    ...
    // updatePositionAccount(bytes32, address) nonpayable returns()
    updatePositionAccount(positionHash, newAccount) {
        return this.connectInfo.tx().sendContractTransaction(this.contract, 'updatePositionAccount', [positionHash, newAccount], {
            value: undefined
        });
    }
    ...
    getPostionPriceIDs(positionHash) {
        return this.connectInfo.multiCall().singleCallObj(this.multicall.getPostionPriceIDs(positionHash));
    }
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PositionServiceContract.prototype, "updatePositionAccount", null);
__decorate([
    (0, tool_1.EnableLogs)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
...
class PositionServiceMultiCall {
    ...
    getPostionPriceIDs(positionHash) {
        return this.mulContract.getPostionPriceIDs(positionHash);
    }
