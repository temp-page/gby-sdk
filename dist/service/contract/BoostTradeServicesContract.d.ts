...
export declare class BoostTradeServicesContract extends BaseAbi {
    ...
    closeBoostTrade(postionHash: string, priceUpdateData: string[], value: string): Promise<TransactionEvent>;
    openBoostTrade(isLong: boolean, targetID: string, tokenID: string, tokenAmount: string, leverage: string, takeProfit: string, priceUpdateData: string[], referral: string, value: string): Promise<TransactionEvent>;
}
