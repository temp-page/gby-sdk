...
function initAddress(ENV) {
    if (ENV === 'prod' || ENV === 'prod_node') {
        ...
        addressInfo.baseApiUrl = "https://www.perpsteet.xyz";
        addressInfo.wsUrl = "https://www.perpsteet.xyz/prep_api/ws";
        addressInfo.graphUrl = "https://www.perpsteet.xyz/graph/subgraphs/name";
        addressInfo.env = ENV;
