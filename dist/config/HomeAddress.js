...
function initAddress(ENV) {
    if (ENV === 'test') {
        ...
        addressInfo.baseApiUrl = "https://testnet-audit.agni.finance";
        addressInfo.wsUrl = "wss://testnet-audit.agni.finance/prep_api/ws";
        addressInfo.graphUrl = "https://testnet-audit.agni.finance/graph/subgraphs/name";
