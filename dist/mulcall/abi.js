...
class Abi {
    static encode(name, inputs, params) {
        try {
            ...
            const functionHash = (0, ethers6_1.keccak256)((0, ethers6_1.toUtf8Bytes)(functionSignature));
            const functionData = functionHash.substring(2, 10);
            const abiCoder = new ethers6_1.AbiCoder();
    ...
    static decode(outputs, data) {
        try {
            const abiCoder = ethers6_1.ethers.AbiCoder.defaultAbiCoder();
